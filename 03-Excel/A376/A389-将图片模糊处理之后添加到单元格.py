...
#模糊图像，并将结果保存在temp目录中
myImage2.filter(ImageFilter.BLUR).save('temp/myImage7.jpg')
#根据temp/myImage2.jpg这个模糊图像(文件)创建图像(myNewImage2)
myNewImage2=openpyxl.drawing.image.Image('temp/myImage7.jpg')
#在生鲜订购表(mySheet)的B5单元格中添加模糊图像(myNewImage2)
