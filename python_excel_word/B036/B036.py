...
##在Word文件(myDocument)中新建6个无序列表项(左端有个小圆点)
myDocument.add_paragraph(text="九月九日忆山东兄弟",style='List Bullet')
myDocument.add_paragraph(text="梦游天姥吟留别",style='List Bullet')
myDocument.add_paragraph(text="凉州词",style='List Bullet')
myDocument.add_paragraph(text="闻官军收河南河北",style='List Bullet')
myDocument.add_paragraph(text="白雪歌送武判官归京",style='List Bullet')
myDocument.add_paragraph(text="春江花月夜",style='List Bullet')
