...
#创建点状样式(myPattern)
myPattern=openpyxl.chart.marker.PatternFillProperties(prst="pct5")
#设置点状样式(myPattern)的前景色为黑色
myPattern.foreground=openpyxl.chart.marker.ColorChoice(prstClr="black")
#设置点状样式(myPattern)的背景色为白色
myPattern.background=openpyxl.chart.marker.ColorChoice(prstClr="white")
#使用白底黑点的点状样式(myPattern)作为柱形图各个柱子的填充样式
